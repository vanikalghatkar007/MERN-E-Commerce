...
const Collection = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt10 border-t '>
      {/* Filter Option */}
      ...
      <div className='flex-1' >
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          ...
          {/* Sort Products */}
          <select onChange={(e)=>setSortType(e.target.value)} className='border-2 border-gray-300 text-sm px-2' name="Sort by" id="">
            <option value="relavant">New arrivals</option>
